...
__global__ void calculatePIgpu(double *sum, double number_rectangles)
{
		// Variables.
		double mid, height;
	
		// Calculation of the width.
		double width = 1.0 / number_rectangles;
...
int main()
{
		...
		// Size of the memory
		double size = NUMBER_RECTANGLES * sizeof(double);
